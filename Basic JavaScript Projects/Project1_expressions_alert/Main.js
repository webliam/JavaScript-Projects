...
function My_First_Function() { //defining  a function name
    ...
    var str=str1+str2; //defin variable

    var result=str.fontcolor("green"); // used fontcolor method
    document.getElementById("Green_Text").innerHTML=result; //result with "text_Gree" id
}
